...
*/
function accessCopyrightPargraph()
{
    var paragraph = document.getElementById("copyright");
    var text = copyright.innerText;
    console.log("content of copyright paragraph is " + text);
    ...
    */
function accessButtonByTagName()
{
    ...
    */
function accessParagraphsByTagName()
{
    var paras = document.getElementsByTagName("p");
    for (var i = 0; i < paras.length; i++)
    {
        var para = paras[i].innerText;
